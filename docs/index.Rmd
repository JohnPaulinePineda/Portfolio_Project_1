---
title: 'R : Data Quality Assessment, Preprocessing and Exploration for a Classification Modelling Problem'
...
# **1. Table of Contents**
|
| This document presents a non-exhaustive list of various data quality assessment, preprocessing and exploration methods for a classification modelling problem using various helpful packages in <mark style="background-color: #CCECFF">**R**</mark>.    
|
##  1.1 Sample Data
|
...
|
| **[D]** The <span style="color: #0000FF">findCorrelation</span> method using <span style="color: #0000FF">cutoff</span> criteria set at 0.95 and the <span style="color: #0000FF">corr_cross</span> method using <span style="color: #0000FF">top</span> criteria set at 10 were applied on the dataset:
...
|
| **[C]** The <span style="color: #0000FF">center</span>, <span style="color: #0000FF">scale</span> and <span style="color: #0000FF">range</span> methods were tried on the dataset. 
|
...
|
| **[C]** The <span style="color: #0000FF">BoxCox</span>, <span style="color: #0000FF">YeoJohnson</span> and <span style="color: #0000FF">expoTrans</span> methods were tried on the dataset. 
|
...
|
| **[C]** The <span style="color: #0000FF">dummyVars</span> method was tried on the dataset. 
|
...
|
| **[C]** The <span style="color: #0000FF">featurePlot</span> method was tried on the dataset. 
|
...
##  1.5 References
|
| **[Book]** [Applied Predictive Modelling Textbook](http://appliedpredictivemodeling.com/) by Max Kuhn and Kjell Johnson
| **[Article]** [Caret Package – A Practical Guide to Machine Learning in R](https://www.machinelearningplus.com/machine-learning/caret-package/) by Selva Prabhakaran
| **[Article]** [Outlier Detection in R](https://statsandr.com/blog/outliers-detection-in-r/) by Antoine Soetewey
